        ...
        <Layout>
            <main className="min-h-screen bg-white">
                ...
                <section className="relative isolate min-h-[520px] overflow-hidden bg-[#3E0F0F]">
                    ...
                    <div className="absolute inset-0 bg-[#3E0F0F]/60" />
                ...
                {/* CTA Section */}
                <section className="relative overflow-hidden bg-[#3E0F0F] px-5 py-16 text-center sm:px-8 lg:py-24">

                    <img
                        src="/src/assets/repair_page.png"
                        alt="Technician repairing electronic hardware"
                        className="absolute inset-0 h-full w-full object-cover opacity-45"
                    />


                    <div className="absolute inset-0 bg-[#3E0F0F]/50" />
